...
class RecheckPopupMonth extends StatefulWidget {
  String dateLabel;
  ...
  @override
  State<RecheckPopupMonth> createState() => _RecheckPopupMonthState();
}

class _RecheckPopupMonthState extends State<RecheckPopupMonth> {
                    ...
                    child: Row(
                      ...
                      children: [
                        TextWidget.textTitle(
                            '${Label.commaFormat(widget.electric_unit)}  kW-hr')
                      ],
                    ),
                  ),
                  const SizedBox(
  ...
  //             var result = await OperatorRequest.createMonthlyDocument(
