...
class ReportListOfficer extends StatefulWidget {
  Station station;
  String role;
  ReportListOfficer({
    Key? key,
  ...
  @override
  State<ReportListOfficer> createState() => _ReportListOfficerState();
}

class _ReportListOfficerState extends State<ReportListOfficer> {
  ...
  showAlertDialog(BuildContext context) async {
    ...
    Widget okButton = TextButton(
      ...
      onPressed: () async {
        ...
        String json = jsonEncode(docId);
        print(json);

        final SharedPreferences prefs = await _prefs;
        String? authorization = prefs.getString('access_token');
        var result = await OfficerRequest.approvalSelect(
            authorization!, docId, 'APPROVE');
        _getDocumentList(
          '',
        );
        setState(() {
