    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          ListItemWidget.cardListDay(Month.getMonthTitle(formattedDate),
              '10.00', context, widget.station, user.role.slug, accessToken),
          ListItemWidget.cardListMonth(Month.getMonthTitle(formattedDate),
              '10.00', context, widget.station, user.role.slug, accessToken),
        ],
      ),
    );
