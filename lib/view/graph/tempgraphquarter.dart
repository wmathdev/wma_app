...
class TempGraphQuarter extends StatefulWidget {
  dynamic data;
  String rule;
  TempGraphQuarter({
    Key? key,
  ...
  @override
  State<TempGraphQuarter> createState() => _TempGraphQuarterState();
}

class _TempGraphQuarterState extends State<TempGraphQuarter> {
