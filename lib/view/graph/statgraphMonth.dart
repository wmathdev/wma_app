...
class StatGraphMonth extends StatefulWidget {
  List<dynamic> data;
  String rule;
  StatGraphMonth({
    Key? key,
  ...
  @override
  State<StatGraphMonth> createState() => _StatGraphMonthState();
}

class _StatGraphMonthState extends State<StatGraphMonth> {
