...
class StatgraphMonthN extends StatefulWidget {
  List<dynamic> data;
  String rule;
  StatgraphMonthN({
    Key? key,
  ...
  @override
  State<StatgraphMonthN> createState() => _StatgraphMonthNState();
}

class _StatgraphMonthNState extends State<StatgraphMonthN> {
