...
class PhGraphQuarter extends StatefulWidget {
  dynamic data;
  String rule;
  PhGraphQuarter({
    Key? key,
  ...
  @override
  State<PhGraphQuarter> createState() => _PhGraphQuarterState();
}

class _PhGraphQuarterState extends State<PhGraphQuarter> {
...
//     }
//         if (widget.rule != '') {
//       int idx = widget.rule.indexOf("-");
//       List parts = [
//         widget.rule.substring(0, idx).trim(),
//         widget.rule.substring(idx + 1).trim()
//       ];

//       listRule.add(HorizontalLine(
//           y: double.parse(parts[0]), color: Colors.blue, dashArray: [4, 4]));
//       listRule.add(HorizontalLine(
//           y: double.parse(parts[1]), color: Colors.blue, dashArray: [4, 4]));
//     }
//   }
...
//       if (value == double.parse(parts[0]) || value == double.parse(parts[1])) {
//         String text = '${value}\nค่ามาตรฐาน';
//         return Container(
//             width: 5,
