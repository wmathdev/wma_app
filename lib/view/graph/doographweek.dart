...
class DooGraphWeek extends StatefulWidget {
  dynamic data;
  String rule;
  DooGraphWeek({
    Key? key,
  ...
  @override
  State<DooGraphWeek> createState() => _DooGraphWeekState();
}

class _DooGraphWeekState extends State<DooGraphWeek> {
