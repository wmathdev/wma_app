...
class TempGraphMonth extends StatefulWidget {
  dynamic data;
  String rule;
  TempGraphMonth({
    Key? key,
  ...
  @override
  State<TempGraphMonth> createState() => _TempGraphMonthState();
}

class _TempGraphMonthState extends State<TempGraphMonth> {
