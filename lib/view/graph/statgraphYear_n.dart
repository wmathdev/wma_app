...
class StatgraphyearN extends StatefulWidget {
  List<dynamic> data;
  String rule;
  StatgraphyearN({
    Key? key,
  ...
  @override
  State<StatgraphyearN> createState() => _StatgraphyearNState();
}

class _StatgraphyearNState extends State<StatgraphyearN> {
