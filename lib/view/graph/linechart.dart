...
class _LineChartSample2State extends State<LineChartSample2> {
  ...
  void initState() {
    ...
    for (var i = 0; i < temp.length; i++) {
      if (temp[i]['document'] != null) {
        listPlot.add(FlSpot(i.toDouble(), temp[i]['document']['doo'] * 1.0));
        listtreatedPlot.add(
            FlSpot(i.toDouble(), temp[i]['document']['treated_doo'] * 1.0));
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    ...
    if (i < temp.length) {
      ...
      text = Container(
          ...
          child: Center(
            child: Text(Month.getGraphDayMonth(widget.data[i]['date']),
                style: style2),
          ));
    } else {
  ...
  LineChartData mainData() {
    ...
    return LineChartData(
      ...
      minY: 0,
      maxY: listtreatedPlot.length.toDouble() + 3.0,
      lineBarsData: [
        LineChartBarData(
          // showingIndicators: [1],
