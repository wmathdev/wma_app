...
class SolarcellReportyearGraph extends StatefulWidget {
  dynamic data;
  int type;

  SolarcellReportyearGraph({Key? key, required this.data, required this.type})
      : super(key: key);

  @override
  State<SolarcellReportyearGraph> createState() => _SolarcellReportyearGraphState();
}

class _SolarcellReportyearGraphState extends State<SolarcellReportyearGraph> {
  ...
  Widget getTitles(double value, TitleMeta meta) {
    ...
    if (i < temp.length) {
      ...
      text = Container(
          ...
          child: Center(
            child: Text(Month.getGraphMonth(widget.data[i]['collect_date']),
                style: style2),
          ));
    } else {
